            ...
            <TabsContent value="signin" className="space-y-6 mt-6 animate-fade-in">
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  className="w-12 h-12 rounded-full p-0 flex items-center justify-center hover:bg-blue-50 border-2 border-procell-primary/20 hover:border-procell-primary transition-all duration-300"
                >
